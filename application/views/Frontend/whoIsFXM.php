		...
		<div class="avatar">
			<div class="annotation">
				<h5>After this we will learn about FXMedia Journey, start from the beginning until now.</h5>
		...
		<script>
			$(document).ready(function() {
				...
				$('video').on('ended', function() {
					...
					$('.annotation h5').html('Go to Session What We Do');
					$('.button-avatar').html('Next Session');
					$("#link").attr('href', '<?= base_url('Home/whatWeDo') ?>');
				});
			});
		</script>
